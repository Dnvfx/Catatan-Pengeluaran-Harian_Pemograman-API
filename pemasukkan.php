...
<head>
	...
	<title>Catatan Pengeluaran Harian-Pemograman API - Pemasukkan</title>
...
<body>
	<div class="header">
		<h3 class="text-secondary font-weight-bold float-left logo">Catatan Pengeluaran Harian</h3>
		<h3 class="text-secondary float-left logo2">- Pemograman API</h3>
		<!-- <a href="logout">
			<div class="logout">
