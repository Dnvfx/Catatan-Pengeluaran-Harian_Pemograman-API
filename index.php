...
<head>
  ...
  <title>Login | Catatan Pengeluaran Harian-Pemograman API</title>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Silahkan registrasi terlebih dahulu</div>
              </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Silahkan login untuk masuk</div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
